...
export default function OncologyTreatmentPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsOncology");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.oncology"), href: `/${locale}/treatments/oncology` }
    ];

    const treatments = [
        {
            title: t("treatments.medical.title"),
            description: t("treatments.medical.description")
        },
        {
            title: t("treatments.surgical.title"),
            description: t("treatments.surgical.description")
        },
        {
            title: t("treatments.radiation.title"),
            description: t("treatments.radiation.description")
        },
        {
            title: t("treatments.breast.title"),
            description: t("treatments.breast.description")
        },
        {
            title: t("treatments.headNeck.title"),
            description: t("treatments.headNeck.description")
        }
    ];
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-pink-50 via-white to-pink-50 py-12 md:py-16">
                <div className="container mx-auto px-4 xl:max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/oncology-cancer-care.svg"
                                alt="Oncology"
                                width={40}
                                height={40}
