...
export default function RehabilitationPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsRehabilitation");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.rehabilitation"), href: `/${locale}/treatments/rehabilitation` }
    ];

    const treatments = [
        { title: t("treatments.physiotherapy.title"), description: t("treatments.physiotherapy.description") },
        { title: t("treatments.neuro.title"), description: t("treatments.neuro.description") },
        { title: t("treatments.postSurgical.title"), description: t("treatments.postSurgical.description") },
        { title: t("treatments.pain.title"), description: t("treatments.pain.description") },
        { title: t("treatments.sports.title"), description: t("treatments.sports.description") }
    ];
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-amber-50 via-white to-amber-50 py-12 md:py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/rehabilitation-recovery.svg"
                                alt="Rehabilitation"
                                width={40}
                                height={40}
