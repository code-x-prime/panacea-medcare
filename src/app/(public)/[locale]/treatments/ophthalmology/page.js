...
export default function OphthalmologyPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsOphthalmology");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.ophthalmology"), href: `/${locale}/treatments/ophthalmology` }
    ];

    const treatments = [
        { title: t("treatments.cataract.title"), description: t("treatments.cataract.description") },
        { title: t("treatments.lasik.title"), description: t("treatments.lasik.description") },
        { title: t("treatments.cornea.title"), description: t("treatments.cornea.description") },
        { title: t("treatments.retina.title"), description: t("treatments.retina.description") },
        { title: t("treatments.glaucoma.title"), description: t("treatments.glaucoma.description") },
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-violet-50 via-white to-violet-50 py-12 md:py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/ophthalmology.svg"
                                alt="Ophthalmology"
                                width={40}
                                height={40}
