...
export default function HospitalsContent({ params }) {
    const { locale } = params;
    ...
    // Unused variable whatsappUrl removed or could be used in the link below if needed, 
    // but the link in existing code was hardcoded with different text. Keeping existing link structure.
