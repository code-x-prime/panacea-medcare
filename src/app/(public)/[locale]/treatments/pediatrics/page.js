...
export default function PediatricsPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsPediatrics");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.pediatrics"), href: `/${locale}/treatments/pediatrics` }
    ];

    const treatments = [
        { title: t("treatments.cardiac.title"), description: t("treatments.cardiac.description") },
        { title: t("treatments.oncology.title"), description: t("treatments.oncology.description") },
        { title: t("treatments.nicu.title"), description: t("treatments.nicu.description") },
        { title: t("treatments.congenital.title"), description: t("treatments.congenital.description") },
        { title: t("treatments.neurology.title"), description: t("treatments.neurology.description") },
        { title: t("treatments.growth.title"), description: t("treatments.growth.description") }
    ];
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-indigo-50 via-white to-indigo-50 py-12 md:py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/paediatrics-paediatric-surgery.svg"
                                alt="Pediatrics"
                                width={40}
                                height={40}
