    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"}>
            <PageHero
                ...
                title={t.title}
                subtitle={t.subtitle}
                backgroundImage="/images/tele-radiology-hero.jpg"
                fallbackImage="https://images.unsplash.com/photo-1516549655169-df83a0774514?q=80&w=2070&auto=format&fit=crop"
            />
