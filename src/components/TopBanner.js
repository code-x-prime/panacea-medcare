...
export default function TopBanner({
  ...
  const displayTitle = title || t("title", { defaultValue: "" });
  const displaySubtitle = subtitle || t("subtitle", { defaultValue: "" });
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        ...
        >
          ...
          {variant !== "light" && (
            <div
              className={`w-16 h-1 bg-panacea-accent rounded-full mb-6 ${
          ...
          {displayTitle && (
            <h1
              className={`${textColor} text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 ${
                isRTL ? "font-arabic" : ""
              }`}
              style={{
                fontFamily:
            ...
            <p
              className={`${
                variant === "light"
                  ...
                  : "text-white/90"
              } text-lg sm:text-xl md:text-2xl font-medium leading-relaxed max-w-3xl ${
                isRTL ? "font-arabic" : ""
              }`}
              style={{
                textShadow:
