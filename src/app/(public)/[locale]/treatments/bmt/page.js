...
export default function BMTTreatmentPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsBMT");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.bmt"), href: `/${locale}/treatments/bmt` }
    ];

    const treatments = [
        {
            title: t("treatments.autologous.title"),
            description: t("treatments.autologous.description")
        },
        {
            title: t("treatments.allogeneic.title"),
            description: t("treatments.allogeneic.description")
        },
        {
            title: t("treatments.haploidentical.title"),
            description: t("treatments.haploidentical.description")
        },
        {
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-cyan-50 via-white to-cyan-50 py-12 md:py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/bone-marrow-transplant.svg"
