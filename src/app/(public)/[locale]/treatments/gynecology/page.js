...
export default function GynecologyPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsGynecology");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.gynecology"), href: `/${locale}/treatments/gynecology` }
    ];

    const treatments = [
        { title: t("treatments.fibroid.title"), description: t("treatments.fibroid.description") },
        { title: t("treatments.endometriosis.title"), description: t("treatments.endometriosis.description") },
        { title: t("treatments.laparoscopic.title"), description: t("treatments.laparoscopic.description") },
        { title: t("treatments.oncology.title"), description: t("treatments.oncology.description") },
        { title: t("treatments.hormonal.title"), description: t("treatments.hormonal.description") },
        { title: t("treatments.pregnancy.title"), description: t("treatments.pregnancy.description") },
        { title: t("treatments.ivf.title"), description: t("treatments.ivf.description") }
    ];
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-rose-50 via-white to-rose-50 py-12 md:py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/gynecology-women-health.svg"
                                alt="Gynecology"
                                width={40}
                                height={40}
