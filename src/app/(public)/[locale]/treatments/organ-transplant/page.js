...
export default function OrganTransplantPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsOrganTransplant");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.transplant"), href: `/${locale}/treatments/organ-transplant` }
    ];

    const treatments = [
        {
            title: t("treatments.liver.title"),
            description: t("treatments.liver.description")
        },
        {
            title: t("treatments.kidney.title"),
            description: t("treatments.kidney.description")
        },
        {
            title: t("treatments.heart.title"),
            description: t("treatments.heart.description")
        },
        {
            title: t("treatments.lung.title"),
            description: t("treatments.lung.description")
        },
        {
            title: t("treatments.pancreas.title"),
            description: t("treatments.pancreas.description")
        },
        {
            title: t("treatments.combined.title"),
            description: t("treatments.combined.description")
        }
    ];
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-green-50 via-white to-green-50 py-12 md:py-16">
                <div className="container mx-auto px-4 xl:max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/organ-transplantation.svg"
