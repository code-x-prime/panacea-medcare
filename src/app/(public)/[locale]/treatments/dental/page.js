...
export default function DentalPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsDental");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.dental"), href: `/${locale}/treatments/dental` }
    ];

    const treatments = [
        { title: t("treatments.implants.title"), description: t("treatments.implants.description") },
        { title: t("treatments.rehabilitation.title"), description: t("treatments.rehabilitation.description") },
        { title: t("treatments.smile.title"), description: t("treatments.smile.description") },
        { title: t("treatments.crowns.title"), description: t("treatments.crowns.description") },
        { title: t("treatments.rootCanal.title"), description: t("treatments.rootCanal.description") },
        { title: t("treatments.whitening.title"), description: t("treatments.whitening.description") },
        { title: t("treatments.pediatric.title"), description: t("treatments.pediatric.description") },
        { title: t("treatments.oral.title"), description: t("treatments.oral.description") }
    ];
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/dental-care-cosmetic-dentistry.svg"
                                alt="Dental Care"
                                width={40}
                                height={40}
