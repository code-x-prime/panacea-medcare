...
export default function LaparoscopicPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsLaparoscopic");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.laparoscopic"), href: `/${locale}/treatments/laparoscopic` }
    ];

    const treatments = [
        { title: t("treatments.gallbladder.title"), description: t("treatments.gallbladder.description") },
        { title: t("treatments.hernia.title"), description: t("treatments.hernia.description") },
        { title: t("treatments.appendix.title"), description: t("treatments.appendix.description") },
        { title: t("treatments.hysterectomy.title"), description: t("treatments.hysterectomy.description") },
        { title: t("treatments.colorectal.title"), description: t("treatments.colorectal.description") },
        { title: t("treatments.bariatric.title"), description: t("treatments.bariatric.description") },
        { title: t("treatments.urology.title"), description: t("treatments.urology.description") },
        { title: t("treatments.cancer.title"), description: t("treatments.cancer.description") }
    ];
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-teal-50 via-white to-teal-50 py-12 md:py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/laparoscopic-surgery.svg"
