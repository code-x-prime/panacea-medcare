...
export default function NeurosurgeryTreatmentPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsNeurosurgery");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.neurosurgery"), href: `/${locale}/treatments/neurosurgery` }
    ];

    const treatments = [
        {
            title: t("treatments.brainTumor.title"),
            description: t("treatments.brainTumor.description")
        },
        {
        ...
        {
            title: t("treatments.stroke.title"),
            description: t("treatments.stroke.description")
        },
        {
            title: t("treatments.dbs.title"),
            description: t("treatments.dbs.description")
        },
        {
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-purple-50 via-white to-purple-50 py-12 md:py-16">
                <div className="container mx-auto px-4 xl:max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/neurosciences.svg"
                                alt="Neurosurgery"
                                width={40}
                                height={40}
