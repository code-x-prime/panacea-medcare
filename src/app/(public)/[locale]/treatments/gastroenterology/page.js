...
export default function GastroenterologyPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsGastroenterology");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.gastroenterology"), href: `/${locale}/treatments/gastroenterology` }
    ];

    const treatments = [
        { title: t("treatments.liver.title"), description: t("treatments.liver.description") },
        { title: t("treatments.endoscopy.title"), description: t("treatments.endoscopy.description") },
        { title: t("treatments.ercp.title"), description: t("treatments.ercp.description") },
        { title: t("treatments.ibd.title"), description: t("treatments.ibd.description") },
        ...
        { title: t("treatments.pancreas.title"), description: t("treatments.pancreas.description") }
    ];
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-yellow-50 via-white to-yellow-50 py-12 md:py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/gastroenterology-hepatology.svg"
