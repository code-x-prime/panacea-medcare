...
export default function MentalHealthPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsMentalHealth");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.mentalHealth"), href: `/${locale}/treatments/mental-health` }
    ];

    const treatments = [
        { title: t("treatments.psychiatry.title"), description: t("treatments.psychiatry.description") },
        { title: t("treatments.depression.title"), description: t("treatments.depression.description") },
        { title: t("treatments.addiction.title"), description: t("treatments.addiction.description") },
        { title: t("treatments.stress.title"), description: t("treatments.stress.description") },
        { title: t("treatments.sleep.title"), description: t("treatments.sleep.description") }
    ];
    ...
    return (
        <main dir={isRTL ? "rtl" : "ltr"} className="bg-white">
            ...
            <section className="bg-gradient-to-br from-emerald-50 via-white to-emerald-50 py-12 md:py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/mental-health-wellness.svg"
                                alt="Mental Health"
                                width={40}
                                height={40}
