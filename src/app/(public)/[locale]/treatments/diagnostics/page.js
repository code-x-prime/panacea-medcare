...
export default function DiagnosticsPage({ params }) {
    const { locale } = params;
    const t = useTranslations("treatmentsDiagnostics");
    const isRTL = locale === "ar";

    const breadcrumbItems = [
        { label: t("breadcrumb.home"), href: `/${locale}` },
        { label: t("breadcrumb.treatments"), href: `/${locale}/treatments` },
        { label: t("breadcrumb.diagnostics"), href: `/${locale}/treatments/diagnostics` }
    ];

    const treatments = [
        { title: t("treatments.teleradiology.title"), description: t("treatments.teleradiology.description") },
        { title: t("treatments.imaging.title"), description: t("treatments.imaging.description") },
        { title: t("treatments.mammography.title"), description: t("treatments.mammography.description") },
        { title: t("treatments.cardiac.title"), description: t("treatments.cardiac.description") },
        { title: t("treatments.interventional.title"), description: t("treatments.interventional.description") },
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-panacea-primary/10 rounded-full mb-6">
                            <Image
                                src="/treatment/diagnostics-advanced-imaging.svg"
                                alt="Diagnostics"
                                width={40}
                                height={40}
